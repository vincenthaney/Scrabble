...
describe('CommunicationBoxComponent', () => {
    ...
    beforeEach(async () => {
        inputParserSpy = jasmine.createSpyObj('InputParserService', ['parseAndSendInput']);
        inputParserSpy.parseAndSendInput.and.callFake(() => {
            return;
        });
    ...
    describe('onSendMessage', () => {
        it('onSendMessage should call appropriate functions if message is not empty', () => {
            ...
            expect(inputParserSpy.parseAndSendInput).toHaveBeenCalled();
        ...
        it('onSendMessage should NOT call appropriate functions if message is empty', () => {
            ...
            component.onSendMessage();
            expect(inputParserSpy.parseAndSendInput).not.toHaveBeenCalled();
