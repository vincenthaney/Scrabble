export const FUN_FACTS: string[] = [
    ...
    "Au Scrabble anglophone, jouer le mot OXYPHENBUTAZONE pourrait marquer 1782 points. Pour obtenir ces points, le joueur de \
    compétition Benjamin Woo l'a joué dans le haut du tableau, frappant trois cases « Mot compte triple » tout en faisant sept mots \
    croisés vers le bas.",
    ...
    'Dans la version anglophone, il y a seulement 2 lettres qui valent 10 points : Q et Z. Dans la version francophone, il y en a \
    5 : K, W, X, Y et Z.',

    "Il y a 19 As dans la version malaisienne de Scrabble. Cela représente près d'un cinquième du nombre total de tuiles du jeu!",
    ...
    "Saviez-vous que plusieurs bruits d'animaux sont des mots acceptés au Scrabble! COINCOIN, CUICUI, GRRR, HIHAN, HOP.",
