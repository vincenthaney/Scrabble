...
// import MongoDbService from '@app/services/database-service/database-service';
...
//         const defaultHighScores: DbHighScores = JSON.parse(dataBuffer);
//         return defaultHighScores.highScores;
//     }

//     addHighScore(score: number, name: string, gameType: GameType): void {}

//     getHighScores(gameType: GameType): DbHighScores {
//         return {};
//     }
