...
export default class WordFindingService {
    ...
    getWordFindingInstance(useCase: WordFindingUseCase, params: PartialWordFindingParameters): AbstractWordFinding {
        const wordFindingParams: WordFindingParameters = [...params, this.dictionaryService.getDefaultDictionary(), this.scoreCalculatorService];
        switch (useCase) {
