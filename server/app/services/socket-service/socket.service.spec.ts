...
describe('SocketService', () => {
    describe('Initialized', () => {
        ...
        describe('getSocket', () => {
            ...
            it('should throw when id is invalid', () => {
                ...
                expect(() => service.getSocket(invalidId)).to.throw(socketErrors.INVALID_ID_FOR_SOCKET);
            });
        });
        ...
        describe('emitToRoom', () => {
            ...
            it('should throw if sio is undefined', () => {
                ...
                expect(() => service.emitToRoom(DEFAULT_ROOM, '_test_event', DEFAULT_ARGS)).to.throw(socketErrors.SOCKET_SERVICE_NOT_INITIALIZED);
                service['sio'] = sio;
            });
        });
        ...
        describe('emitToSocket', () => {
            ...
            it('should throw if sio is undefined', () => {
                const sio = service['sio'];
                service['sio'] = undefined;
                expect(() => service.emitToSocket(id, '_test_event', DEFAULT_ARGS)).to.throw(socketErrors.SOCKET_SERVICE_NOT_INITIALIZED);
                service['sio'] = sio;
            });
        });
    });
    ...
    describe('Not initialized', () => {
        ...
        describe('handleSockets', () => {
            it('should throw', () => {
                expect(() => service.handleSockets()).to.throw(socketErrors.SOCKET_SERVICE_NOT_INITIALIZED);
            });
        });

        describe('addToRoom', () => {
            it('should throw if ID is invalid', () => {
                expect(() => service.addToRoom(INVALID_ID, DEFAULT_ROOM)).to.throw(socketErrors.SOCKET_SERVICE_NOT_INITIALIZED);
            });
        });

        describe('deleteRoom', () => {
            it('should throw if ID is invalid', () => {
                expect(() => service.deleteRoom(INVALID_ID)).to.throw(socketErrors.SOCKET_SERVICE_NOT_INITIALIZED);
            });
        });
    });
});
